...
public:
    ...
    void setupUi(QMainWindow *MainWindowClass)
    {
        ...
        QIcon icon30;
        icon30.addFile(QStringLiteral(":/images/Resources/images/Reset.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionResetArcBall->setIcon(icon30);
        ...
        dockWidgetCommand->setMinimumSize(QSize(80, 38));
